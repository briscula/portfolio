...
export const formatTimePeriod = (
  ...
  return (
    translations[period][locale] || translations[period]["en-US"] || period
  );
};
...
export const formatPaymentType = (
  ...
  return (
    translations[paymentType][locale] ||
    translations[paymentType]["en-US"] ||
    paymentType
  );
};
...
export const formatTrendDirection = (
  ...
  return (
    translations[direction][locale] ||
    translations[direction]["en-US"] ||
    direction
  );
};
...
export const formatConfidenceLevel = (
  ...
  return (
    translations[confidence][locale] ||
    translations[confidence]["en-US"] ||
    confidence
  );
};
