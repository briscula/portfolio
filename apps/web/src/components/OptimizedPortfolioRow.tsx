...
export const OptimizedPortfolioRow = memo<OptimizedPortfolioRowProps>(
  ({
    ...
    const formattedValues = React.useMemo(() => {
      ...
      const unrealizedGain = formatCurrency(
    ...
    return (
      ...
      >
          ...
          >
            <div className="flex flex-col">
              <span
                className={cn(
                  "font-medium",
                  formattedValues.gainFormatted.color === "green"
                    ? "text-green-600"
                    : formattedValues.gainFormatted.color === "red"
                      ? "text-red-600"
                      : "text-gray-600",
                )}
              >
        ...
        {visibleColumns.yield && (
          <td
            className="hidden lg:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-900"
            role="gridcell"
          >
        ...
        {visibleColumns.updated && (
          <td
            className="hidden xl:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"
            role="gridcell"
          >
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.portfolio.metrics.totalValue ===
        nextProps.portfolio.metrics.totalValue &&
      prevProps.portfolio.metrics.unrealizedGain ===
        nextProps.portfolio.metrics.unrealizedGain &&
      prevProps.portfolio.metrics.unrealizedGainPercent ===
        nextProps.portfolio.metrics.unrealizedGainPercent &&
      prevProps.portfolio.metrics.dividendYield ===
        nextProps.portfolio.metrics.dividendYield &&
      prevProps.portfolio.metrics.positionCount ===
        nextProps.portfolio.metrics.positionCount &&
      prevProps.portfolio.metrics.lastUpdated.getTime() ===
        nextProps.portfolio.metrics.lastUpdated.getTime() &&
      ...
      prevProps.visibleColumns?.currency ===
        nextProps.visibleColumns?.currency &&
      ...
      prevProps.visibleColumns?.positions ===
        nextProps.visibleColumns?.positions &&
